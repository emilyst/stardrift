//! Color utilities for body color generation.
//!
//! This module provides color management capabilities for the N-body simulation,
//! including physically-based color temperature conversion and random color
//! generation. The bloom/emissive ramp that used to be baked into per-body
//! materials here now lives in the bodies plugin's shader (`body.wgsl`).
//!
//! # Key Features
//!
...
//! - **Palette generation**: Colorblind-safe, scientific, aesthetic, and pride palettes
//!
//! # Temperature Ranges
//!
